...
@section('javascript')
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBwnQc1Gfi9LN7SOVUMRDM6JbEAl1SZ-Rc&amp;libraries=places"></script>
    <script type="text/javascript">
        ...
        function initialize() {
            ...
            google.maps.event.addListener(autocomplete,'place_changed', function(){
                ...
                var long = place.geometry.location.F;
            });
        };
    </script>
    <script>
